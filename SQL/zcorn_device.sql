...
CREATE TABLE `device` (
  ...
  `id$user` int DEFAULT NULL COMMENT 'the userid of the IoT user',
  ...
  CONSTRAINT `device_ibfk_2` FOREIGN KEY (`id$user`) REFERENCES `user` (`id`)
...
INSERT INTO `device` VALUES (1,'1#ss',1,25,0,NULL,0,'123',1,1,1,0),(2,'1#ts',2,25,0,NULL,0,'111',1,1,2,0),(3,'1#ca',3,-1,0,NULL,0,'546',1,1,3,0),(4,'1#wd',4,0,1,1751284287338,0,'765',1,1,4,0),(5,'1#ds',5,0,1,1751388449962,0,'6554',1,1,5,0),(6,'1#ws',6,0,1,1751284177941,0,'678',1,1,6,0),(7,'2#ss',1,25,0,NULL,0,'656',2,1,7,0),(8,'2#ts',2,20,0,NULL,0,'446',2,1,8,0),(9,'2#ca',3,-1,0,NULL,0,'767',2,1,9,0),(10,'2#wd',4,0,1,NULL,0,'876',2,1,10,0),(11,'2#ds',5,0,1,NULL,0,'735',2,1,11,0),(12,'2#ws',6,0,1,NULL,0,'789',2,1,12,0);
...
-- Dump completed on 2025-07-02  2:07:29
